...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,
        ...
        qqemail_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]]/,
        qqemail_filter = /^.+@qq\.com$/, // exmaple email "steve@s-i.photo"
        phone_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]\@\.]/,
        phone_filter = /^1[34578][0-9]{9}$/;  // exmaple phone "13203836651"
        IDCard_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]\@\.]/,
        IDCard_filter = /^[1-9]\d{5}((1[89]|20)\d{2})(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])\d{3}[\dx]$/i;  // exmaple IDCard "410181199103151000"
        ch_zn_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]\@\.]/,
    ...
    */
    tests = {
        ...
        qqemail : function(a){
            if ( !qqemail_filter.test( a ) || a.match( qqemail_illegalChars ) ){
                alertTxt = a ? message.qqemail : message.empty;
                return false;
            }
            return true;
        },
