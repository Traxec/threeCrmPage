...
var jDialog = (function($, undefined){
        ...
        buttons: function(buttons){
            ...
            if(buttons && buttons.length > 0) {
                ...
                $.each(buttons,function(i,btn){
                    ...
                    v = btn.text || '确定';
                    htmlBtns.push('<input id="test1" type="button" class="' + cls + '" value="' + v + '" />');
                });
    ...
    var _alert = function(content,button,options){
        ...
        options = $.extend({
            ...
            title : options.title ? options.title : '<div style="height:30px;border-bottom:1px solid #f8bdbf;"><span style="margin-left:100px;color:#f2343b;font-size:16px;margin-bottom:20px;">温馨提示</span></div>'
        });
